...
async function getPrivacyPolicy() {
  try {
    const document = await client.fetch(`
      *[_type == "legalDocument" && documentType == "privacy-policy" && status == "published"] | order(effectiveDate desc)[0] {
        _id,
        title,
        slug,
        documentType,
            ...
            <Card className="bg-white shadow-lg">
              <CardContent className="p-12 text-center">
                ...
                <p className="text-gray-600 mb-6">
                  We're working on updating our privacy policy. Please check back soon or contact us directly.
                </p>
